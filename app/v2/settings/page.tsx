    ...
    <div style={{ minHeight: "100dvh", background: "var(--canvas)" }}>
      ...
      <div style={{ maxWidth: "72rem", margin: "0 auto" }}>
        ...
        <Card eyebrow="Account">
          <SettingsRow icon={ICON.person} tint="rgba(26,158,143,0.12)" label="Edit profile" sublabel="Name, age range, photo" onClick={() => router.push("/v2/profile-setup")} />
          <SettingsRow icon={ICON.sliders} tint="rgba(217,166,46,0.14)" label="Skin & hair concerns" sublabel="Tune what your reports focus on" onClick={() => router.push("/v2/profile-setup")} />
        </Card>
        ...
        <Card eyebrow="Reports & support">
          <SettingsRow icon={ICON.folder} tint="rgba(26,158,143,0.12)" label="Scan reports" sublabel="Every report you've unlocked" onClick={() => router.push("/v2/history")} />
